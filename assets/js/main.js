(function($){
	...
	jQuery(document).on('ready', function () {
		...
		if(document.getElementById("particles-js")) particlesJS("particles-js", {
            "particles": {
                ...
                "color": {
                    "value": ["#a4bc32", "#000000", "#a4bc32", "#000000"]
                },
                "shape": {
                    "type": "circle",
                    "stroke": {
	...
	// Go to Top
        $(function(){
            ...
            $(window).on('scroll', function(){
                var scrolled = $(window).scrollTop();
                if (scrolled > 600) $('.what').addClass('active');
                if (scrolled < 600) $('.what').removeClass('active');
            }); 
    ...
    //boton premios
    $('a.scroll-premios').on('click', function (e) {
        e.preventDefault();
        var seccionOffsetTop = $($(this).attr('href')).offset().top - 40;
